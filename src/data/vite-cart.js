...
export let cart;
export function loadFromLoculStorage() {
...
export function addToCart(fruidsId) {
    let matchingItem;
...
export function removeFromCart(fruidsId) {
    let newCart = [];
...
export function auditTheCart(fruidsId, selectedDeliveryOptionId) {
    let matchingItem;
